...
export function LiveSellingCounter({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
      ...
      <div
        className={`transition-all duration-500 ease-in-out opacity-0 translate-y-4 pointer-events-none absolute w-full flex justify-center z-30 hidden md:flex`}
      >
        <div
          ...
          style={{
            ...
            background: "#1d1d1b",
            boxShadow:
              "0 8px 24px rgba(0, 0, 0, 0.2), inset 0 0 0 1px rgba(223, 176, 1, 0.3)",
          }}
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(223, 176, 1, 0.05) 0%, rgba(255, 255, 255, 0.02) 100%)",
            }}
          />
          ...
          <div className="flex flex-col justify-center flex-1 px-8 z-10">
            <div className="flex justify-between text-[10px] text-white/70 mb-1.5">
              ...
              <span className="text-[#dfb001] flex items-center gap-1">
                <TrendingUp className="w-3 h-3" /> Fast Selling
              </span>
            </div>
